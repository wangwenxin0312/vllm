...
class GPUModelRunner(LoRAModelRunnerMixin):
    ...
    def execute_model(
        ...
        with set_forward_context(
            ...
            # print(f"slot_mapping:{attn_metadata["model.layers.0.self_attn.attn"].slot_mapping}")
            # print(f"block_table:{attn_metadata["model.layers.0.self_attn.attn"].block_table}")
            # print(f"query_start_loc:{attn_metadata["model.layers.0.self_attn.attn"].query_start_loc}")
